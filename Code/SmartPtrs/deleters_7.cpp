...
int main() {
	...
	// 0 - Create a shared_ptr to int[10] and run with valgrind, can you see the problem? WARNING, THIS IS BAD CODE! USE STL CONTAINERS!!! 
	std::shared_ptr<int> sp(new int[10]);

	// 1 - Fix the bug with a custom deleter.  WARNING, THIS IS BAD CODE! USE STL CONTAINERS!!! 
	...
	// 3 - Create unique_ptr of Object that dumps the status at delete time
