...
namespace detail_{
    ...
    struct value_tuple_mixed_{

        typedef value_tuple_mixed_<RunTimeTuple, Pair ...> type;
        ...
        constexpr
        value_tuple_mixed_( ArgsRuntime const& ... args ): m_args_runtime(args...) {
        }
        ...
        auto get() const {
            return
                static_if<not_contained<sizeof ... (Pair)-1, Idx>()>::apply(
                    m_args_runtime
                    , s_args_constexpr
                    ).template get<Idx>() ;
        }
    ...
    //annoying verbosity
    template <typename RunTimeTuple, typename ... Pair>
    constexpr const typename value_tuple_mixed_<RunTimeTuple, Pair ...>::constexpr_tuple_t value_tuple_mixed_<RunTimeTuple, Pair ...>::s_args_constexpr;

    template <typename RunTimeTuple, typename ... Pair>
    constexpr const typename value_tuple_mixed_<RunTimeTuple, Pair ...>::array_t value_tuple_mixed_<RunTimeTuple, Pair ...>::coordinates;
...
namespace detail_{
    ...
    struct value_tuple_mixed{
        ...
        typedef value_tuple_mixed<RunTimeTuple, Pair ...> type;
        static const short n_dim = RunTimeTuple::n_dim+sizeof...(Pair);
        static const short n_dim_constexpr = sizeof...(Pair);
        static const short n_dim_runtime = RunTimeTuple::n_dim;
        using constexpr_tuple_t = make_value_tuple<int, n_dim>;
    ...
    //annoying verbosity
    template <typename RunTimeTuple, typename ... Pair>
    constexpr const typename value_tuple_mixed<RunTimeTuple, Pair ...>::constexpr_tuple_t value_tuple_mixed<RunTimeTuple, Pair ...>::s_args_constexpr;

    template <typename RunTimeTuple, typename ... Pair>
    constexpr const typename value_tuple_mixed<RunTimeTuple, Pair ...>::array_t value_tuple_mixed<RunTimeTuple, Pair ...>::coordinates;
