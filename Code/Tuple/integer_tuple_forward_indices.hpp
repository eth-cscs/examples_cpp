...
namespace detail_ {
    ...
    template<std::size_t NDim, typename Index >
    struct sized_integer_tuple
        : public sized_integer_tuple<NDim, std::integral_constant<std::size_t,Index::value+1>>
    {
    private:
        static const std::size_t n_dim=NDim;

        typedef sized_integer_tuple<NDim, std::integral_constant<std::size_t,Index::value+1>> super;
        static const std::size_t s_index=Index::value;
    ...
    public:
        template <int Idx, typename... GenericElements>
            ...
            super( t, x... ),
            m_offset(initialize<s_index>(t, x...))
            {
    ...
    struct sized_integer_tuple<NDim, std::integral_constant<std::size_t,NDim+1> >
    {
        static const std::size_t n_dim=NDim;
        ...
        static const std::size_t s_indexs=NDim+1;
...
using integer_tuple=detail_::sized_integer_tuple<Length, std::integral_constant<std::size_t,1>>;
